...
function validateField(validation, value) {
  return (0, _fastLoops.objectReduce)(validation, function (error, validate, message) {
...
function useField(_ref) {
  ...
  var type = (0, _typeof2.default)(value); // add a special validation for required fields where the browser doesn't auto catch
  ...
  var props = (_props = {
    name: name
  }, (0, _defineProperty2.default)(_props, type === 'boolean' ? 'checked' : 'value', field.value), (0, _defineProperty2.default)(_props, "loading", field.isLoading), (0, _defineProperty2.default)(_props, "disabled", field.isDisabled), (0, _defineProperty2.default)(_props, "required", field.isRequired), (0, _defineProperty2.default)(_props, "errorMessage", field.isTouched ? field.errorMessage : undefined), (0, _defineProperty2.default)(_props, "isValid", field.isTouched ? !field.errorMessage : true), (0, _defineProperty2.default)(_props, "onChange", onChange), _props); // by default, we always hide validation errors once the field is focused again
