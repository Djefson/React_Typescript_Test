...
:root {
  ...
  --color-primitive-red: #bf2012;
  --color-primitive-grey-100: #141414;
  --color-primitive-grey-200: #707070;
  --color-primitive-grey-300: #d5d5d5;
  --color-primitive-grey-400: #ebebeb;
  --color-primitive-grey-500: #fafafa;
  --color-brand-primary: #284e80; /* The primary brand color, used sparingly to create brand associated UI components. */
  --color-foreground-primary: #141414; /* Use for primary text and icons */
  --color-foreground-secondary: #707070; /* Use for secondary text and icons */
  --color-foreground-inverted: #ffffff; /* Use for inverted text and icons */
  --color-foreground-alert: #bf2012; /* Use for highlighting errors, invalid data, and destructive actions */
  --color-foreground-action: #1c6bba; /* Use for links and other interactive elements */
  --color-ornament-border: #d5d5d5; /* Use as ornamental color to create borders around UI elements */
  --color-ornament-divider: #ebebeb; /* Use as a ornamental color to separate UI elements */
  --color-ornament-highlight: #1c6bba; /* Use for highlighting selected and focus states */
  --color-ornament-alert: #bf2012;
  --color-background-primary: #ffffff; /* Primary background */
  --color-background-secondary: #fafafa; /* Secondary backround */
  --color-ornament-border: #d5d5d5; /* Use as ornamental color to create borders around UI elements */
  --form-field-border-width: 1;
  --form-field-border-radius: 4;
  --color-foreground-alert: #bf2012; /* Use for highlighting errors, invalid data, and destructive actions */
  --form-field-invalid-border-width: 2;
  --color-foreground-alert: #bf2012; /* Use for highlighting errors, invalid data, and destructive actions */
  --color-foreground-secondary: #707070; /* Use for secondary text and icons */
  --color-foreground-primary: #141414; /* Use for primary text and icons */
  --color-background-primary: #ffffff; /* Primary background */
  ...
  --color-primitive-grey-300: #d5d5d5;
  --color-primitive-accent-blue: #1c6bba;
  --form-field-focus-label-offset: 8;
  --form-field-focus-label-size: 12;
  --form-field-padding-vertical: 12;
  --form-field-padding-horizontal: 16;
  --animation-duration-cheetah: 60; /* Use for small UI transitions that happen frequently */
  --font-family-volvo-novum: Volvo Novum, sans-serif;
  --form-field-font-height: 1.5;
  --form-field-font-size: 16;
  --color-foreground-secondary: #707070; /* Use for secondary text and icons */
  --form-field-label-offset: 18;
  --form-field-label-size: 16;
  --color-primitive-accent-blue: #1c6bba;
  --color-primitive-accent-blue: #1c6bba;
  --color-primitive-white: #ffffff;
  --color-primitive-grey-200: #707070;
  ...
  --color-primitive-grey-300: #d5d5d5;
  --animation-duration-cheetah: 60; /* Use for small UI transitions that happen frequently */
  --animation-duration-elk: 150;
  --animation-duration-snail: 300;
  --font-family-volvo-novum: Volvo Novum, sans-serif;
  ...
  --text-peary-medium-font-size: 52px;
  --text-peary-medium-line-height: 56px;
